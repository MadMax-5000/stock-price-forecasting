...
def create_model(**kwargs: Any) -> XGBClassifier:
    """
    Create an XGBClassifier with given or default parameters.
...
def train_and_evaluate(
    ...
    """
    Train XGBoost model and run backtest.
    ...
    print_benchmark_table(results, "XGBoost", show_extended=show_extended)
