...
def create_model(**kwargs: Any) -> LogisticRegression:
    """
    Create a LogisticRegression with given or default parameters.
...
def train_and_evaluate(
    ...
    """
    Train Logistic Regression model and run backtest.
    ...
    print_benchmark_table(results, "Logistic Regression", show_extended=show_extended)
