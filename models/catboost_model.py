...
def create_model(**kwargs: Any) -> CatBoostClassifier:
    """
    Create a CatBoostClassifier with given or default parameters.
...
def train_and_evaluate(
...
) -> tuple[pd.DataFrame, CatBoostClassifier]:
    """
    ...
    print_benchmark_table(results, "CatBoost", show_extended=show_extended)
