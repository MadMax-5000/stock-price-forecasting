...
def create_model(**kwargs: Any) -> Lasso:
    """
    Create a Lasso model with given or default parameters.

    Args:
        **kwargs: Model parameters to override defaults.

    Returns:
        Configured Lasso instance.
    """
...
def train_and_evaluate(
...
) -> tuple[pd.DataFrame, Lasso]:
    """
    Train Lasso model and run backtest.
    ...
    print_benchmark_table(results, "Lasso Regression", show_extended=show_extended)
