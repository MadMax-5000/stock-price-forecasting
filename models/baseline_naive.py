...
def predict_signal(test: pd.DataFrame) -> pd.DataFrame:
    """Returns predictions based on previous day's close direction."""
...
def print_benchmark_table(predictions: pd.DataFrame, model_name: str = "Naive Baseline") -> None:
...
if __name__ == "__main__":
    ...
    print_benchmark_table(results, "Naive")
