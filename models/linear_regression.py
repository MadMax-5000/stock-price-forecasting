...
def create_model(**kwargs: Any) -> LinearRegression:
    """
    Create a LinearRegression model with given or default parameters.

    Args:
        **kwargs: Model parameters to override defaults.

    Returns:
        Configured LinearRegression instance.
    """
...
def train_and_evaluate(
    ...
    """
    Train Linear Regression model and run backtest.
    ...
    print_benchmark_table(results, "Linear Regression", show_extended=show_extended)
