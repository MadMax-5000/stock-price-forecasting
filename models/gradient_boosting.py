...
def create_model(**kwargs: Any) -> GradientBoostingClassifier:
    """
    Create a GradientBoostingClassifier with given or default parameters.
...
def train_and_evaluate(
...
) -> tuple[pd.DataFrame, GradientBoostingClassifier]:
    """
    Train Gradient Boosting model and run backtest.
    ...
    print_benchmark_table(results, "Gradient Boosting", show_extended=show_extended)
