...
def create_model(**kwargs: Any) -> ExtraTreesClassifier:
    """
    Create an ExtraTreesClassifier with given or default parameters.
...
def train_and_evaluate(
...
) -> tuple[pd.DataFrame, ExtraTreesClassifier]:
    """
    Train Extra Trees model and run backtest.
    ...
    print_benchmark_table(results, "Extra Trees", show_extended=show_extended)
