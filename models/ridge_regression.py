...
def create_model(**kwargs: Any) -> RidgeClassifier:
    """
    Create a RidgeClassifier with given or default parameters.

    Args:
        **kwargs: Model parameters to override defaults.

    Returns:
        Configured RidgeClassifier instance.
    """
...
def train_and_evaluate(
...
) -> tuple[pd.DataFrame, RidgeClassifier]:
    """
    Train Ridge Regression model and run backtest.
    ...
    print_benchmark_table(results, "Ridge Regression", show_extended=show_extended)
